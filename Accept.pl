...
#2014-02-19		Lana Zwart		This script automatically accepts
#    							components in bulk that have previously	
#                               been checked in by programmers. 
...
#     that you'd like to accept. The programmer will have this Input file
#     which he/she would have used during the check-in operation. 
...
sub AcceptC {
	...
	print "\nChanging to $AcceptDir";	
	print "Accepting ... $Component\n";
	print STDERR "\nAccepting $Component";	
	
	@AcptCmd = `accept $Component`;
